namespace CAS.Laporan
{
    partial class FrmLBKK
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.BBKEx1.ExSqlQuery = "Select kas as BBK,kas.date from kas where left(kas,3) = \'BKK\'";
            ...
            this.BBKEx2.ExSqlQuery = "Select kas as BBK,kas.date from kas where left(kas,3) = \'BKK\'";
            ...
            this.Name = "FrmLBKK";
            this.Load += new System.EventHandler(this.FrmLBKK_Load);
