namespace CAS.Laporan
{
    partial class FrmLBKM
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.BBKEx1.ExSqlQuery = "Select kas as BBK,kas.date from kas where left(kas,3) = \'BKM\'";
            ...
            this.BBKEx2.ExSqlQuery = "Select kas as BBK,kas.date from kas where left(kas,3) = \'BKM\'";
            ...
            this.Name = "FrmLBKM";
            this.Load += new System.EventHandler(this.FrmLBKM_Load);
