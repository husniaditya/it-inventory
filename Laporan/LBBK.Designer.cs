namespace CAS.Laporan
{
    partial class FrmLBBK
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.BBKEx1.ExSqlQuery = "Select kas as BBK,kas.date from kas where left(kas,3) = \'BBK\'";
            ...
            this.BBKEx2.ExSqlQuery = "Select kas as BBK,kas.date from kas where left(kas,3) = \'BBK\'";
            ...
            this.Name = "FrmLBBK";
            this.Load += new System.EventHandler(this.FrmLBBK_Load);
