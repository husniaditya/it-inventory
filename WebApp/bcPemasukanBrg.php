...
<div id="page-wrapper">   
    ...
    <div class="panel-default">
        ...
        if (isset($_POST["btnPreview"]) || isset($_POST["btnCSV"] ) || isset($_POST["btnPDF"] )) {
            ...
            $query = "SELECT @num := @num + 1 AS no,temp.* from (select jenis, nodoc, datedoc, lpb, lpbdate, supplier, inv, remark, qty, unit, val, sub FROM bcmasuk ";
            $query .= "      JOIN (SELECT @num :=0) AS n ON 1=1";
            $query .= "      WHERE lpbdate >=" . $tglAwal . " and lpbdate < adddate(" . $tglAkhir . ",1)";
            ...
            if ($_POST["txtDocA"] == "") {
                if ($_POST["txtDocZ"] == "")
                    $query .= "AND (nodoc BETWEEN '' and 'zzz') ";
                else
            ...
            if ($_POST["jnsA"] == "") {
                if ($_POST["jnsZ"] == "")
                    $query .= "AND (jenis BETWEEN '' and 'zzz')";
                else
        ...
        if (isset($_POST["btnCSV"]) ) {
            ...
            if ($num > 0) {
                ...
                $exHtml .= '<p>KAWASAN BERIKAT PT. KARYAINDAH ALAM SEJAHTERA</p>';
                ...
                $exHtml .= "<tr>"
                   ...
                   . "<th>TGL DOK. PABEAN</th><th>NO BUKTI PENERIMAAN</th><th>TGL BUKTI PENERIMAAN</th>"
                   . "<th>PEMASOK/PENGIRIM</th><th>KODE BARANG</th><th>NAMA BARANG</th>"
        ...
        if(isset($_POST["btnPDF"])){
            ...
            $tablehead = array('NO', 'JENIS DOK', 'NO DOK PABEAN', 'TGL DOK PABEAN',
                'NO.PENERIMAAN', 'TGL PENERIMAAN', 'PEMASOK',
