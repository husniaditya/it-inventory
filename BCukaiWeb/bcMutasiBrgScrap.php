                ...
                <div class="modal-body">
                    <table id="lookupIA" class="table table-bordered table-hover table-striped">
                        <thead>
                         ...
                         <tbody>
                            <?php
                            $sql = mysql_query('SELECT inv AS Kode, name AS Persediaan FROM inv WHERE flag = 0 and left(inv,2) = 71 ;');
...
<div id="page-wrapper">   
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header" style="font-size: 25px;">BC Mutasi Scrap</h1>
        </div>
    </div>
    ...
    <div class="panel-default">        
        ...
        if (isset($_POST["btnPreview"]) || isset($_POST["btnCSV"] ) || isset($_POST["btnPDF"] )) {
            ...
            $query .= "      where rin.period='" . $period . "' and left(rin.inv,1)='7' ";
            // $query .= "      where rin.period='" . $period . "' and left(rin.inv,1)='7' ";
            $query .= "     union all ";
            ...
            $query .= "      where sjhdate < " . $tglAwal . " and month(sjhdate)=month(" . $tglAwal . ") and year(sjhdate)=year(" . $tglAwal . ") and left(bckeluar.inv,2)='71' ";
            $query .= "  ) as oawal ";
            if ($_POST["txtInvA"] == "") {
                if ($_POST["txtInvZ"] == "")
            ...
            $query .= "       where left(ind.inv,2) = '71' and (ind.date>=" . $tglAwal . " and ind.date<adddate(" . $tglAkhir . ",1)) ";
            if ($_POST["txtInvA"] == "") {
                if ($_POST["txtInvZ"] == "")
            ...
            $query .= " and  left(ind.inv,2) = '71' and left(ind.jurnal,3) in ('LHP','OPN','JIN','BPP','SJL','LPR','LPB') ";
        ...
        if (isset($_POST["btnCSV"])) {
            ...
            if ($num > 0) {
                ...
                header("Content-Disposition: attachment; filename=BC_Laporan_PertanggungJawaban_Mutasi_Barang_Scrap.xls");
