...
<div id="page-wrapper">   
    ...
    <div class="panel-default">        
        ...
        if (isset($_POST["btnPreview"]) || isset($_POST["btnCSV"] ) || isset($_POST["btnPDF"] )) {
            ...
            $query .= "      where sjhdate < " . $tglAwal . " and month(sjhdate)=month(" . $tglAwal . ") and year(sjhdate)=year(" . $tglAwal . ") and left(bckeluar.inv,1)='4' ";
            $query .= "  ) as oawal ";
            if ($_POST["txtInvA"] == "") {
                if ($_POST["txtInvZ"] == "")
            ...
            $query .= "       where left(ind.inv,1) = '4' and (ind.date>=" . $tglAwal . " and ind.date<adddate(" . $tglAkhir . ",1)) ";
            if ($_POST["inv"] == "") {
                if ($_POST["invZ"] == "")
            ...
            $query .= " and  left(ind.inv,1) = '4' and left(ind.jurnal,3) in ('LHP','OPN','JIN','BPP','SJL','LPR','LPB') ";
            $query .= " union all " ;
