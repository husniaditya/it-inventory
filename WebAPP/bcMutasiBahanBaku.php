...
<div id="page-wrapper">   
    ...
    <div class="panel-default">
        ...
        if (isset($_POST["btnPreview"]) || isset($_POST["btnCSV"] ) || isset($_POST["btnPDF"] ) ) {
            ...
            $query .= "      where rin.period='" . $period . "' and (left(rin.inv,1)='1' or left(rin.inv,1)='2') ";
            $query .= "     union all ";
            ...
            $query .= "      where lpbdate < " . $tglAwal . " and month(lpbdate)=month(" . $tglAwal . ") and year(lpbdate)=year(" . $tglAwal . ")  and (left(bcmasuk.inv,1)='1' or  left(bcmasuk.inv,1)='2') ";
            $query .= "  ) as oawal  ";
            if ($_POST["txtInvA"] == "") {
                if ($_POST["txtInvZ"] == "")
            ...
            $query .= "  and (left(ind.inv,1) = '1' or left(ind.inv,1) = '2') and left(ind.jurnal,3) in ('OPN','JIN','BPP','SJL','LHP') ";
            $query .= " union all ";
            ...
            $query .= "     and (left(bcmasuk.inv,1) = '1' or left(bcmasuk.inv,1) = '2') ";
            $query .= " union all ";
            $query .= " select bcmasuk.remark as invname,bcmasuk.inv,'' as loc, ";
            $query .= "       bcmasuk.lpbdate,bcmasuk.lpb,'' as rem,0 as s_awal, ";
