<?php
  ...
  function _lO2($_ll3)
  {
	  /*$handle = fopen("md5.txt","a");fwrite($handle,"\r\n".$_ll3."\r\n".md5($_ll3));fclose($handle); *//* hacked by ivan budiono :) */
	  if($_ll3 == "")
		return "008eba53f81f684b5b4a8ee9d1635fef";
	  else
        return md5($_ll3);
  }
  function _lO3()
  ...
  class _li10
  {
      static $_li10 = "{0}{trademark}<div id='{id}' style class='{style}KCD'>{view}{viewstate}{settings}{QMS}{1}</div>{2}";
  }
  function _lO5()
  {
      $_ll6 = _lO6();
  ...
  function _lOf(&$_llg)
  {
      ...
      for ($_lO9 = 0; $_lO9 < 3; $_lO9++)
          if ((_llb() % 3) != $_lO9)
              $_llg = _lO0(_lOa(0173) . $_lO9 . _lOa(0175), _lOi(), $_llg);
      $_llg = _lO0(_lOa(0173) . (_llb() % 3) . _lOa(0175), (!(_llb() % $_llh)) ? _lld() : _lOi(), $_llg);
      return($_llh == _lOh());
  }
  function _lld()
  {
  ...
  if (!class_exists("KoolCalendar", false)) {
      ...
      class _llz
      {
          ...
          function _ll13()
          {
              ...
              $_ll14 = "<input id='{id}' name='{id}' type='hidden' value='{value}' autocomplete='off' />";
      ...
      class koolcalendar
      {
          ...
          function init()
          {
              ...
              if ($this->FocusedDate === null)
                  $this->FocusedDate = time();
              if ($this->SelectedDates === null)
                  $this->SelectedDates = array();
              if ($this->FastNavigationStep === null)
                  $this->FastNavigationStep = 3 * $this->MultiViewColumns * $this->MultiViewRows;
              $this->_lO18();
          }
          function _lO18()
          {
          ...
          function _ll1e()
          {
              ...
              if ($this->ClientMode) {
                  ...
                  switch (strtolower($this->DayNameFormat)) {
                      case "short":
                          $_ll1h = $this->Localization->_llu;
                          break;
                      case "firstletter":
                          $_ll1h = $this->Localization->_llv;
                          break;
                      case "firsttwoletters":
                          $_ll1h = $this->Localization->_lOv;
                          break;
                      case "shortest":
                          $_ll1h = $this->Localization->_lOu;
                          break;
                  }
              ...
              $_lO1h = "<input id='{id}_settings' type='hidden' value='{value}' autocomplete='off' />";
          ...
          function _lO1e()
          {
              ...
              $_lO1h = "<input id='{id}_viewstate' name='{id}_viewstate' type='hidden' value='{value}' autocomplete='off' />";
              $_ll1i = _lO0("{id}", $this->id, $_lO1h);
          ...
          function _ll1g()
          {
              ...
              $_lO1j = "<div id='{id}' class='kcdQMS' style='display:none;'><table border='0' cellspacing='0' ><tbody>{trs}</tbody></table></div>";
              $_ll1k = "<tr>{tds}</tr>";
              $_lO1k = "<td id='{id}' class='kcdMonth'><a>{text}</a></td>";
              $_ll1l = "<td id='{id}' class='kcdMonth kcdSeparate'><a>{text}</a></td>";
              $_lO1l = "<td id='{id}' class='kcdYear'><a>{text}</a></td>";
              $_ll1m = "<td id='{id}_qms_{dir}'><a>{text}</a></td>";
              $_lO1m = "<tr><td class='kcdButtons' colspan='4'>{today}{ok}{cancel}</td></tr>";
              $_ll1n = "<input id='{id}_qms_{button}'type='button' value='{value}' class='kcdButton{button}' />";
              $_lO1n = $_ll1j["year"] - 4;
              $_ll1o = "";
          ...
          function _ll1f()
          {
              ...
              $_lO1u = getdate($_lO1t);
              $_ll1v = getdate($_ll1u);
              $_lO1j = "<table cellspacing='0' border='0' class='kcdMultiView' style='{width}{height}'>{head}<tbody><tr><td class='kcdMultiViewContainer' style='overflow:hidden;'>{subtable}</td></tr></tbody>{foot}</table>";
              $_lO1v = "<thead>{trs}</thead>";
              $_ll1w = "<tr><th colspan='{colspan}' class='kcdTopHeader'>{fastnav}{nav}<span class='kcdNavText {qms}'>{from_month}{sep}{to_month}</span></th></tr>";
              $_lO1w = "<span class='kcdFastPrev'><a>&lt;&lt;</a></span><span class='kcdFastNext'><a>&gt;&gt;</a></span>";
              $_ll1x = "<span class='kcdPrev'><a>&lt;</a></span><span class='kcdNext'><a>&gt;</a></span>";
              $_lO1x = "<table cellspacing='0' border='0' style='width:100%;'>{body}</table>";
              ...
              if ($this->ClientMode) {
                  $_lO1s = _lO0("{subtable}", "<div><table class='kcdTableSlide' style='width:100%;' border='0' cellpadding='0' cellspacing='0'><tr><td>{subtable}</td></tr></table></div>", $_lO1s);
              }
          ...
          function _lO1f($_lOp = null, $_ll25 = true)
          {
              ...
              $_lO25 = getdate($_lOp);
              $_lO1j = "<table cellspacing='0' cellpadding='0' border='0' class='kcdMonthView' style='{width}{height}'>{head}{body}{foot}</table>";
              $_lO1v = "<thead>{trs}</thead>";
              $_ll26 = "<tr><th class='kcdTopHeader'>{fastnav}{nav} {text}</th></tr>";
              $_lO26 = "<span class='kcdNavText {qms}'>{text}</span>";
              $_lO1w = "<span class='kcdFastPrev'><a>&lt;&lt;</a></span><span class='kcdFastNext'><a>&gt;&gt;</a></span>";
              $_ll1x = "<span class='kcdPrev'><a>&lt;</a></span><span class='kcdNext'><a >&gt;</a></span>";
              $_ll1y = "<tbody><tr><td class='kcdMain' style='overflow:hidden'>{detail}</td></tr></tbody>";
              ...
              $_lO23 = $_ll1y;
              if ($_ll25) {
                  $_lO23 = _lO0("{detail}", "<div><table class='kcdTableSlide'  border='0' cellpadding='0' cellspacing='0' style='width:100%;'><tr><td>{detail}</td></tr></table></div>", $_lO23);
              }
          ...
          function _ll29($_lO29)
          {
              ...
              if ($_lO2d < 0)
                  $_lO2d += 7;
              $_ll2e = _llp($_lO2c, -$_lO2d);
              $_lO1j = "<table cellspacing='0' border='0' class='kcdMainTable'>{head}{body}</table>";
              $_lO1v = "<thead><tr>{th_selector}{ths}</tr></thead>";
              $_lO2e = "<th class='kcdColHeader' title='{title}'>{text}</th>";
              $_ll2f = "<th class='kcdColHeader kcdViewSelector'>{text}</th>";
              $_ll1y = "<tbody>{trs}</tbody>";
              $_lO1y = "<tr>{th}{tds}</tr>";
              $_lO2f = "<th class='kcdRowHeader' title='{title}'>{text}</th>";
              $_ll1z = "<td abbr='{abbr}' class='{class}' {title}><a>{text}</a></td>";
              $_ll2g = "";
              ...
              for ($_lO1o = 0; $_lO1o < $_lO2b; $_lO1o++) {
                  ...
                  for ($_lO1p = 0; $_lO1p < $_ll2b; $_lO1p++) {
                      ...
                      if (isset($this->_ll16[date("n/j/Y", $_llq)])) {
                          ...
                          $_lO22 = _lO0("{title}", ($_lO2j["ToolTip"] !== null) ? "title='" . $_lO2j["ToolTip"] . "'" : "", $_lO22);
                      }
          ...
          {
              $_lO2k = "<script type='text/javascript'>if(typeof _libKCD=='undefined'){document.write(unescape(\"%3Cscript type='text/javascript' src='{src}'%3E %3C/script%3E\"));_libKCD=1;}</script>";
          ...
          {
              $this->_lO2l();
              $_lO2k = "<script type='text/javascript'>if (document.getElementById('__{style}KCD')==null){var _head = document.getElementsByTagName('head')[0];var _link = document.createElement('link'); _link.id = '__{style}KCD';_link.rel='stylesheet'; _link.href='{stylepath}/{style}/{style}.css';_head.appendChild(_link);}</script>";
          ...
          function startupscript()
          {
              ...
              $_lO2k .= "if (typeof(KoolCalendar)=='function'){{id}_init();}";
              $_lO2k .= "else{if(typeof(__KCDInits)=='undefined'){__KCDInits=new Array();} __KCDInits.push({id}_init);{register_script}}";
              $_lO2n = "if(typeof(_libKCD)=='undefined'){var _head = document.getElementsByTagName('head')\1330];var _script = document.createElement('script'); _script.type='text/javascript'; _script.src='{src}'; _head.appendChild(_script);_libKCD=1;}";
      ...
      class kooltimeview
      {
          ...
          {
              $_ll2q = "{0}{trademark}<div id='{id}' style class='{style}KCD'>{table}{settings}{1}</div>{2}";
              $_lO1d = "\n<!--KoolTimeView version {version} - www.koolphp.net -->\n";
              $_lO1j = "<table class='ktmTable' border='0' cellspacing='0'>{head}{body}</table>";
              $_lO1v = "<thead><tr><th class='ktmHeader' colspan='{colspan}'>{text}</th></tr></thead>";
              $_ll1y = "<tbody>{trs}</tbody>";
              $_ll1k = "<tr>{tds}</tr>";
              $_lO1k = "<td class='{time} {colpos}' abbr='{abbr}'><a>{text}</a></td>";
              ...
              for ($_lO1o = 0; $_lO1o < $_lO2r; $_lO1o++) {
                  ...
                  for ($_lO1p = 0; $_lO1p < $this->NumberOfColumns; $_lO1p++) {
                      ...
                      } elseif ($_lO1p == $this->NumberOfColumns - 1) {
          ...
          {
              $_lO2k = "<script type='text/javascript'>if(typeof _libKCD=='undefined'){document.write(unescape(\"%3Cscript type='text/javascript' src='{src}'%3E %3C/script%3E\"));_libKCD=1;}</script>";
              $_ll1c = _lO0("{src}", $this->_ll2l() . "\077" . md5("js"), $_lO2k);
              return $_ll1c;
          }
          function _lO2l()
          {
          ...
          function startupscript()
          {
              ...
              $_lO2k .= "if (typeof(KoolTimeView)=='function'){{id}_init();}";
              $_lO2k .= "else{if(typeof(__KCDInits)=='undefined'){__KCDInits=new Array();} __KCDInits.push({id}_init);{register_script}}";
              $_lO2n = "if(typeof(_libKCD)=='undefined'){var _head = document.getElementsByTagName('head')\1330];var _script = document.createElement('script'); _script.type='text/javascript'; _script.src='{src}';_head.appendChild(_script);_libKCD=1;}";
              $_ll2o = _lO0("{src}", $this->_ll2l() . "?" . md5("js"), $_lO2n);
              $_ll1c = _lO0("{id}", $this->id, $_lO2k);
      ...
      class kooldatetimepicker
      {
          ...
          {
              $_ll2q = "{0}{trademark}<div id='{id}_bound' style='{stylecss}' class='{style}KCD'>{view}{datepicker}{timepicker}{settings}{1}</div>{2}";
              $_lO1d = "\n<!--KoolDateTimePicker version {version} - www.koolphp.net -->\n";
              $_lO2v = "<div id='{id}_datepicker' class='kcdDatePicker' style='display:none;position:absolute;'>{calendar}</div>";
              $_ll2w = "<div id='{id}_timepicker' class='kcdTimePicker' style='display:none;position:absolute;'>{timeview}</div>";
              $_lO2w = "<table border='0' cellpadding='0' cellspacing='0' style='width:100%;'><tr><td class='kcdInput'><div><input id='{id}' name='{id}' value='{value}' style='width:100%;{style}' type='text' autocomplete='off'/></div></td>{dateopener}{timeopener}</tr></table>";
              $_ll2x = "";
              $_lO2x = "";
              if ($this->_lO2t) {
              ...
              if ($this->_ll2u) {
                  ...
                  $_lO2y = "<td class='kcdPicker'><a id='{id}_timeopener' class='kcdTimeOpener'></a></td>";
          ...
          function startupscript()
          {
              ...
              $_lO2k .= "else{if(typeof(__KCDInits)=='undefined'){__KCDInits=new Array();} __KCDInits.push({id}_init);{register_script}}";
              $_lO2n = "if(typeof(_libKCD)=='undefined'){var _head = document.getElementsByTagName('head')[0];var _script = document.createElement('script'); _script.type='text/javascript'; _script.src='{src}';_head.appendChild(_script);_libKCD=1;}";
              $_ll2o = _lO0("{src}", $this->_ll2l() . "\077" . md5("js"), $_lO2n);
              $_ll1c = _lO0("{id}", $this->id, $_lO2k);
