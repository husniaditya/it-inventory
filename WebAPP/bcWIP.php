...
<div id="page-wrapper">   
    ...
    <div class="panel-default" >
        ...
        if (isset($_POST["btnPreview"]) || isset($_POST["btnCSV"] ) || isset($_POST["btnPDF"] )) {
            ...
            $query .= "      where rin.period='" . $period . "' and left(rin.inv,1)<='4' and left(rin.loc,2) like 'GP%' ";
            $query .= "     union all ";
            ...
            $query .= "       and left(ind.inv,1)<='4' and left(ind.loc,2) like 'GP%' ";
            ...
            $query .= "       if (ind.dk='D' and left(ind.loc,2) like 'GP%' , ind.qty , 0) as qdebet, ";
            $query .= "       if (ind.dk='K' and left(ind.loc,2) like 'GP%' , ind.qty , 0) as qkredit, ";
            $query .= "       0 as qadjust, ";
