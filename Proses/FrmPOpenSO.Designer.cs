namespace CAS.Proses
{
    partial class FrmPOpenSO
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label6.Text = "Rencana terima di set > 0 maka Open SO akan close jika counternya >= rencana teri" +
            ...
            this.label5.Text = "Rencana terima default 0 = tak terhingga sehingga Open SO akan close jika kedatan" +
                "gan >= qty + toleransi";
            // 
            // label4
            // 
            ...
            this.label4.Text = "Proses ini akan membuka SO berdasarkan Qty + Toleransi dan berapa kali pengiriman" +
            ...
            this.label3.Text = "Proses Open SO";
            // 
            // casDataSet
            // 
            ...
            this.Name = "FrmPOpenSO";
            this.Text = "FrmPOpenPO";
            this.Load += new System.EventHandler(this.FrmPOpenSO_Load);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FrmPOpenSO_FormClosing);
